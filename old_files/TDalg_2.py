...
# %% [markdown]
# # TD Approach for solving k-maximum visibility
...
# %%
def TDkMaximumVisibility(T,outer,Q,k, gdf, targetPolygon,Boundary):
    '''
    ...
    while (cont == True):
        ...
        for qp in VQ.keys():
            if (nodeId in LO[qp]):
                ...
                vrset[qp] = updateVisibility(asPoint2(queryPoint_i),T,outer,vrset[qp],node)
